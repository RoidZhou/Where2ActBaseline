...
python gen_offline_data_custom.py \
...
python -m pdb gen_offline_data_custom.py --data_dir ../data/grasp_train_data --data_fn ../grasp_stats/train_data_list.txt --num_processes 6 --num_epochs 150 
'''
